<div class="share-container clearfix">
    ...
    <ul class="rrssb-buttons clearfix">
        <li class="email">
            <a href="mailto:?subject=Check%20out%20how%20ridiculously%20responsive%20these%20social%20buttons%20are&amp;body=<?php echo get_permalink(); ?>">
                <span class="icon">
        ...
        <li class="twitter">
            <a href="http://twitter.com/home?status=<?php echo addslashes(get_the_title()); ?>%20<?php echo get_permalink(); ?>%20via%20@workhands" class="popup">
                <span class="icon">
...
<!--    <li class="tumblr">
        ...
        <li class="linkedin">
            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo get_permalink(); ?>&amp;title=<?php echo addslashes(get_the_title()); ?>" class="popup">
                <span class="icon">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
...
<!--                <li class="reddit">
        ...
        <li class="googleplus">
            <a href="https://plus.google.com/share?url=<?php echo addslashes(get_the_title()); ?><?php echo get_permalink(); ?>" class="popup">
                <span class="icon">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                        <g>
                            <g>
